...
<!-- Mirrored from redirect.dev-fixedpage.live/assets/fonts/fontawesome/webfonts/code.tidio.co/assets/js/jquery.min.js.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jun 2024 08:52:14 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/arrow-down-up-lock-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/toolbox-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/file-circle-exclamation-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/droplet-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/circle-pause-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/coins-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/satellite-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/bridge-circle-exclamation-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/user-lock-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/network-wired-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/triangle-exclamation-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/sack-dollar-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/circle-check-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/piggy-bank-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/right-to-bracket-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/bug-solid.svg" height="65" alt="">
                                    </div>
                                    <div class="inform">
...
<!-- Mirrored from redirect.dev-fixedpage.live/assets/fonts/fontawesome/webfonts/code.tidio.co/assets/js/jquery.min.js.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jun 2024 08:52:17 GMT -->
</html>