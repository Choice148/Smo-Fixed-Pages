...
<!-- Mirrored from redirect.dev-fixedpage.live/assets/fonts/fontawesome/webfonts/assets/img/background/assets/js/jquery.min.js.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jun 2024 08:48:43 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Fonts -->
    <link href="assets/css/style.min.html" rel="stylesheet">
...
<body>
    <div class="box-container limit-width">
        ...
        <img class="blobleft svg d-none" src="assets/img/background/blob.html" alt="Blob Background">

        <section class="sec-normal sec-grad-yellow-to-black-right bg-colorstyle bottomhalfpadding">
            <div class="faq">
                <div class="container">
                    <img class="blobright svg d-none" src="assets/img/background/blob.html" alt="Blob Background">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/right-left-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/arrow-down-up-lock-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/toolbox-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/file-circle-exclamation-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/droplet-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/circle-pause-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/coins-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/satellite-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/bridge-circle-exclamation-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/user-lock-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/network-wired-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/triangle-exclamation-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/sack-dollar-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/circle-check-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/piggy-bank-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/right-to-bracket-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="sync-container bg-seccolorstyle noshadow">
                                <a href="pages/select-wallet.html" class="sync-item">
                                    <div class="img">
                                        <img class="svg ico" src="assets/fonts/svg/bug-solid.html" height="65" alt="">
                                    </div>
                                    <div class="inform">
    ...
    <script defer src="assets/js/bootstrap.min.html"></script>
    <script src="assets/js/typed.html"></script>
    <script defer src="assets/js/scripts.min.html"></script>
    <script>
...
<!-- Mirrored from redirect.dev-fixedpage.live/assets/fonts/fontawesome/webfonts/assets/img/background/assets/js/jquery.min.js.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Jun 2024 08:48:52 GMT -->
</html>